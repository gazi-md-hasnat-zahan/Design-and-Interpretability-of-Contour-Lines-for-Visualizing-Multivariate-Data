...
CX2[:,1] = np.interp(CX1[:,1], (np.min(CX1[:,1]), np.max(CX1[:,1])), (-39, 129))

DX2[:,0] = np.interp(DX1[:,0], (np.min(DX1[:,0]), np.max(DX1[:,0])), (69, 219))
DX2[:,1] = np.interp(DX1[:,1], (np.min(DX1[:,1]), np.max(DX1[:,1])), (50, 239))
...
dfB.to_csv(r'E:\Research\CHI Project\Controlled Experiment\4 variables\Data\Bm23.csv')
