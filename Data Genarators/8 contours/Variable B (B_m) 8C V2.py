...
AX1, AY1 = make_gaussian_quantiles(n_samples=40000,cov=5, n_features=2, n_classes=8)
BX1, BY1 = make_gaussian_quantiles(n_samples=40000,cov=5, n_features=2, n_classes=8)
CX1, CY1 = make_gaussian_quantiles(n_samples=40000,cov=5, n_features=2, n_classes=9)
DX1, DY1 = make_gaussian_quantiles(n_samples=40000,cov=5, n_features=2, n_classes=9)
...
BX2[:,0] = np.interp(BX1[:,0], (np.min(BX1[:,0]), np.max(BX1[:,0])), (-15, 119))
BX2[:,1] = np.interp(BX1[:,1], (np.min(BX1[:,1]), np.max(BX1[:,1])), (69, 209))

CX2[:,0] = np.interp(CX1[:,0], (np.min(CX1[:,0]), np.max(CX1[:,0])), (69, 209))
CX2[:,1] = np.interp(CX1[:,1], (np.min(CX1[:,1]), np.max(CX1[:,1])), (-10, 119))

DX2[:,0] = np.interp(DX1[:,0], (np.min(DX1[:,0]), np.max(DX1[:,0])), (79, 189))
DX2[:,1] = np.interp(DX1[:,1], (np.min(DX1[:,1]), np.max(DX1[:,1])), (70, 209))
...
for i in range(200):
    for j in range(200):
        if i < 100:
            ...
            #Bn
            if level875countB[i][j] ==0 and level125countB[i][j] == 0 and level25countB[i][j] == 0 and level375countB[i][j] ==0 and level50countB[i][j] == 0 and level675countB[i][j] == 0 and level75countB[i][j] == 0:
                continue;
...
dfB.to_csv(r'E:\Research\CHI Project\Controlled Experiment\4 variables\Data\Bm27.csv')
